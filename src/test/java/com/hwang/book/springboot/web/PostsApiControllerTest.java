...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) //WithMockUser 사용위해 MockMvc 사용해야함
...
//        ResponseEntity<Long> responseEntity = restTemplate.postForEntity(url, requestDto, Long.class);
        //설정된 Mock을 통해 API 테스트
        mvc.perform(post(url)
                .contentType(MediaType.APPLICATION_JSON_UTF8)   //본문 영역은 문자열로 표현하기 위해 ObjectMapper 통해 JSON변환
