...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)     //@WebMvcTest의 경우 JPA기능 작동하지 않음, Controller, ControllerAdvice 등 외부 연동과 관련된 부분만 활성화됨, JPA 기능까지 한번에 테스트 할때는 @SpringBootTest와 TestRestTemplete사용
